...
class UserOnTheFlyController extends Controller
{
    ...
    public function hasCreateAccessAction(
        ...
        try {
            ...
            if (!$permissionResolver->canUser('content', 'create', $userCreateStruct, [$locationCreateStruct])) {
            ...
            if (!$permissionResolver->canUser('content', 'publish', $userCreateStruct, [$locationCreateStruct])) {
                throw new UnauthorizedException(
                    'content',
                    'publish',
                    [
    ...
    public function editUserAction(
        ...
        if (null === $location && $user->contentInfo->isPublished()) {
            ...
            $location = $this->locationService->loadLocation((int)$user->mainLocationId);
        }
