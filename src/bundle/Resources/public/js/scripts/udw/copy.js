(function(Translator) {
    ...
    const openUDW = (event) => {
        ...
        const confirmLabel = Translator.trans(/*@Desc("Copy to location")*/ 'confirm.label', {}, 'admin_ui_udw_copy');
        const title = Translator.trans(/*@Desc("Select location")*/ 'title', {}, 'admin_ui_udw_copy');
