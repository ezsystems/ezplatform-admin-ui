...
class ContentUpdateForm extends Element
{
    ...
    public function __construct(BrowserContext $context)
    {
        ...
        $this->fields = [
            ...
            'closeButton' => '.ez-content-edit-container__close, .ibexa-content-edit-sidebar__header .ibexa-content-edit-sidebar__back',  // TODO: Set one selector after redesign
            'fieldLabel' => '.ez-field-edit__label-wrapper label.ez-field-edit__label, .ez-field-edit__label-wrapper legend, .ez-card > .card-body > div > div > legend, .ez-field-edit--eznoneditable > legend.col-form-label',
