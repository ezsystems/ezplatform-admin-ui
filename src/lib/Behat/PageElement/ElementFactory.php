...
class ElementFactory
{
     ...
     *
     * @return AdminList|Dialog|SystemInfoTable|RightMenu|UpperMenu|UpdateForm|Breadcrumb|Notification|NavLinkTabs|UniversalDiscoveryWidget Element to interact with
     */
