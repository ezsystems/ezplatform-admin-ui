...
class ContentUpdateItemPage extends Page
{
    ...
    protected function specifyLocators(): array
    {
        return [
            ...
            new VisibleCSSLocator('fieldLabel', '.ez-field-edit__label-wrapper label.ez-field-edit__label, .ez-field-edit__label-wrapper legend, .ez-card > .card-body > div > div > legend, .ez-field-edit--eznoneditable > legend.col-form-label'),
            new VisibleCSSLocator('nthField', '.ez-card .card-body > div > div > div:nth-of-type(%s)'),
